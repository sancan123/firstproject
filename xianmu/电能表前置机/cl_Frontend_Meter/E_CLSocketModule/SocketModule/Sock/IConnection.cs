...
namespace E_CLSocketModule.SocketModule.Sock
{
    interface IConnection
    {
        ...
        bool SendData(ref byte[] vData, bool IsReturn, int WaiteTime, int MaxByte);
        ...
        /// <param name="WaiteTime">发送后等待时间</param>
        /// <returns>发送是否成功</returns>
        bool SendData(ref byte[] vData, bool IsReturn, int WaiteTime, int MaxByte, int MaxWaitSeconds);
    }
}
