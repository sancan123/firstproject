...
out string[] FrameAry);
    ...
    ComVisible(true)]
    public class CL188M : IClass_Interface
    {
        public int int_Id = 0;
        /// <summary>
        /// 
        /// </summary>
        private bool[] m_b_SelectStatus = new bool[0];

        public bool[] B_SelectStatus
        {
            get { return m_b_SelectStatus; }
            set { m_b_SelectStatus = value; }
        }
        /// <summary>
        /// 当前通道号
        /// </summary>
        private int m_int_ChannelNo;
        /// <summary>
        /// 当前通道号
        /// </summary>
        public int Int_ChannelNo
        {
            get { return m_int_ChannelNo; }
            set { m_int_ChannelNo = value; }
        }
        /// <summary>
        /// 通道数
        /// </summary>
        private int m_int_ChannelNum;
        /// <summary>
        /// 通道数
        /// </summary>
        public int Int_ChannelNum
        {
            get { return m_int_ChannelNum; }
            set { m_int_ChannelNum = value; }
        }
        /// <summary>
        /// 重试次数
        /// </summary>
        ...
        public int InitSetting(int ComNumber, int MaxWaitTime, int WaitSencondsPerByte, string IP, int RemotePort, int LocalStartPort, string HaveProtocol)
        {
            ...
            try
            {
                driverBase.RegisterPort(ComNumber, m_Port.m_Port_Setting, m_Port.m_IP, RemotePort, LocalStartPort, HaveProtocol, MaxWaitTime, WaitSencondsPerByte);
            }
            catch (Exception)
            {
        ...
        public int Connect(int Id, out string[] FrameAry)
        {
            ...
            rc2.ChannelNo = Int_ChannelNo;
            rc2.ChannelNum = Int_ChannelNum;
            rc2.BwStatus = B_SelectStatus;
        ...
        public int SetPulseChannelAndType(int Id, int pram1, int pram2, int pram3, int pram4, int pram5, out string[] FrameAry)
        {
            ...
            try
            {
                ...
                rc2.ChannelNo = Int_ChannelNo;
                rc2.ChannelNum = Int_ChannelNum;
                rc2.SetPara((Cus_EmMeterWcChannelNo)pram1, (Cus_EmPulseType)pram2, (Cus_EmGyGyType)pram3, (Cus_EmDgnWcChannelNo)pram4, (Cus_EmCheckType)pram5, Int_ChannelNum);
                rc2.BwStatus = B_SelectStatus;
                FrameAry[0] = BytesToString(rc2.GetPacketData());
                int intRst = 1;
                if (SendFlag)
        ...
        public int UpdateLogin(int id, out string[] FrameAry)
        {
            ...
            {
                rc.Pos = id;
                rc.ChannelNo = Int_ChannelNo;
                rc.ChannelNum = Int_ChannelNum;
                rc.BwStatus = B_SelectStatus;
        ...
        public int StartRemoteSignals(int Id, int p_int_RemoteCount, int p_int_OutputType, int p_int_PulseCount, float p_flt_PulseOutHz, float p_flt_OutMultiple, out string[] p_str_OutFrame)
        {
            ...
            rc.Pos = Id;
            rc.SetPara(B_SelectStatus, p_int_RemoteCount, p_int_OutputType, p_int_PulseCount, p_flt_PulseOutHz, p_flt_OutMultiple);
        ...
        public int StopOutPut(int id, int p_int_CheckType, int p_int_RemoteCount, out string[] p_str_OutFrame)
        {
            ...
            rc.ChannelNum = Int_ChannelNum;
            rc.BwStatus = B_SelectStatus;
            rc.SetParam(B_SelectStatus, p_int_CheckType, p_int_RemoteCount);
        ...
        public int SetSelectLightStatus(int Id, byte p_byt_SelectType, out string[] p_str_OutFrame)
        {
            ...
            rc.Pos = Id;
            rc.SetPara(B_SelectStatus, (Cus_EmLightSelect)p_byt_SelectType, Int_ChannelNo, Int_ChannelNum);
        ...
        public int SetSelectCheckRoad(int id, byte iroad, byte vroad, out string[] FrameAry)
        {
            int intRst = 1;
            FrameAry = new string[1];
            CL188M_RequestSelectCheckRoadPacket rc = new CL188M_RequestSelectCheckRoadPacket(id, (Cus_EmBothIRoadType)iroad, (Cus_EmBothVRoadType)vroad);
        ...
        public int SetBwVolCutIsolation(int id, int p_int_IsolationStatus, out string[] p_str_OutFrame)
        {
            ...
            rc.ChannelNo = Int_ChannelNo;
            rc.ChannelNum = Int_ChannelNum;
            rc.SetPara(B_SelectStatus, p_int_IsolationStatus == 1 ? true : false, Int_ChannelNo, Int_ChannelNum);
        ...
        public int SetCTPosition(int id, byte CtType, out string[] FrameAry)
        {
            int intRst = 1;
            FrameAry = new string[1];
            CL188M_RequestCTPositionChannelControlPacket rc = new CL188M_RequestCTPositionChannelControlPacket(id, (Cus_EmIChannelType)CtType);
        ...
        public int ReadCurrentData(int id, byte wcbVerifyType, out byte verificationType, out int MeterIndex, out int ErrorNum, out string wcData, out bool[] statusType, out byte CurrentContour, out byte VoltageContour, out byte CommunicationType, out bool[] workType, out byte expandStatus, out string[] FrameAry)
        {
            ...
            workType = new bool[8];
            expandStatus = 0;
            CL188M_RequestReadBwWcAndStatusPacket rc = new CL188M_RequestReadBwWcAndStatusPacket((Cus_EmWuchaType)wcbVerifyType);
        ...
        public int ReadFirstTenTimesData(int id, byte wcbVerifyType, out byte verificationType, out int MeterIndex, out int ErrorNum, out string[] wcDatas, out string wcData, out bool[] statusType, out byte CurrentContour, out byte VoltageContour, out byte CommunicationType, out bool[] workType, out string[] FrameAry)
        {
            ...
            workType = new bool[8];
            FrameAry = new string[1];
            CL188M_RequestReadBwLast10WcAndStatusPacket rc = new CL188M_RequestReadBwLast10WcAndStatusPacket(id, (Cus_EmWuchaType)wcbVerifyType);
        ...
        {
            bool[] state = new bool[B_SelectStatus.Length];
            bool[] offstate = new bool[B_SelectStatus.Length];

            //MeterDataHelper.Instance

            for (int i = 0; i < B_SelectStatus.Length; i++)
            {
                // MeterInfo meter = App.CUS.Meters[i];
                state[i] = true;
                offstate[i] = true;
                //if (MeterDataHelper.Instance.GetYaoJian()[i])
                //{
                //    offstate[i] = false;
                //}
                //else
            ...
            CL188M_RequestSetSwitchPacket req = new CL188M_RequestSetSwitchPacket(0, 1)
            {
                BwStatus = B_SelectStatus,
                Pos = 0,
                ChannelNo = Int_ChannelNo,
                ChannelNum = Int_ChannelNum
            };
            CL188M_RequestSetSwitchReplayPacket res = new CL188M_RequestSetSwitchReplayPacket();
            if (SendFlag)
            {
                if (SendPacketWithRetry(m_Port, req, res))
                {
                    //intRst = res.ReciveResult == RecvResult.OK ? 0 : 2;
                }
            }
            else
            {
            ...
            CL188M_RequestSetSwitchPacket req2 = new CL188M_RequestSetSwitchPacket(2, 0)
            {
                BwStatus = B_SelectStatus,
                Pos = 0,
                ChannelNo = Int_ChannelNo,
            ...
            CL188M_RequestSetSwitchReplayPacket res2 = new CL188M_RequestSetSwitchReplayPacket();
            if (SendFlag)
            {
                if (SendPacketWithRetry(m_Port, req2, res2))
                {
                    //intRst = res2.ReciveResult == RecvResult.OK ? 0 : 2;
                }
            }
            else
            {
            ...
            CL188M_RequestSetSwitchPacket req3 = new CL188M_RequestSetSwitchPacket(3, 0)
            {
                BwStatus = B_SelectStatus,
                Pos = 0,
                ChannelNo = Int_ChannelNo,
            ...
            CL188M_RequestSetSwitchReplayPacket res3 = new CL188M_RequestSetSwitchReplayPacket();
            if (SendFlag)
            {
                if (SendPacketWithRetry(m_Port, req3, res3))
                {
                    //intRst = res3.ReciveResult == RecvResult.OK ? 0 : 2;
                }
            }
            else
            {
            ...
            CL188M_RequestSetSwitchPacket req1 = new CL188M_RequestSetSwitchPacket(1, 1)
            {
                BwStatus = B_SelectStatus,
                Pos = 0,
                ChannelNo = Int_ChannelNo,
            ...
            CL188M_RequestSetSwitchReplayPacket res1 = new CL188M_RequestSetSwitchReplayPacket();
            if (SendFlag)
            {
                if (SendPacketWithRetry(m_Port, req1, res1))
                {
                    //intRst = res1.ReciveResult == RecvResult.OK ? 0 : 2;
                }
            }
            else
            {
        ...
        public int InitSwitch2()
        {
            ...
            CL188M_RequestSetSwitchPacket req11 = new CL188M_RequestSetSwitchPacket(1,0)
            {
                BwStatus = offstate,
                Pos = 0,
                ChannelNo = Int_ChannelNo,
            ...
            CL188M_RequestSetSwitchReplayPacket res11 = new CL188M_RequestSetSwitchReplayPacket();
            if (SendFlag)
            {
                if (SendPacketWithRetry(m_Port, req11, res11))
                {
                    intRst = res1.ReciveResult == RecvResult.OK ? 0 : 2;
                }
            }
