...
namespace E_CL188M.Device
{
    ...
    internal class CL188M_RequestSelectCheckRoadPacket : CL188LSendPacket
    {
        ...
        public CL188M_RequestSelectCheckRoadPacket(bool[] bwstatus, Cus_EmBothIRoadType iroad, Cus_EmBothVRoadType vroad, int iChannelNum, int iChannelNo)
            : base(true)
        {
            this.ChannelNum = iChannelNum;
            this.Pos = 0;
        ...
        public CL188M_RequestSelectCheckRoadPacket(int id, Cus_EmBothIRoadType iroad, Cus_EmBothVRoadType vroad)
            : base(true)
        {
            this.Pos = id;
            this.iRoad = iroad;
    ...
    internal class CL188M_RequestStopPCFunctionPacket : CL188LSendPacket
    {
        ...
        /// <param name="bwstatus"></param>
        /// <param name="checktype"></param>
        public CL188M_RequestStopPCFunctionPacket(bool[] bwstatus, Cus_EmCheckType checktype, int iChannelNum)
            : base(true)
        {
            this.ChannelNum = iChannelNum;
            this.isStart = true;
    ...
    internal class CL188M_RequestCTPositionChannelControlPacket : CL188LSendPacket
    {
        ...
        public CL188M_RequestCTPositionChannelControlPacket(bool[] bwstatus, Cus_EmIChannelType itype, int iChannelNum)
            : base(true)
        {
            this.ChannelNum = iChannelNum;
            this.BwStatus = bwstatus;
        ...
        public CL188M_RequestCTPositionChannelControlPacket(int id, Cus_EmIChannelType itype)
            : base(true)
        {
            this.Pos = id;
            this.iType = itype;
    ...
    internal class CL188M_RequestReadBwWcAndStatusPacket : CL188LSendPacket
    {
        ...
        public CL188M_RequestReadBwWcAndStatusPacket(Cus_EmWuchaType wcType)
            : base(true)
        {
    ...
    internal class CL188M_RequestReadBwLast10WcAndStatusPacket : CL188LSendPacket
    {
        ...
        /// <param name="bwstatus">表位状态</param>
        /// <param name="wcType">检定误差类型</param>
        public CL188M_RequestReadBwLast10WcAndStatusPacket(bool[] bwstatus, Cus_EmWuchaType wcType)
            : base(true)
        {
            this.BwStatus = bwstatus;
            this.wcBoardQueryType = (int)wcType;
        ...
        public CL188M_RequestReadBwLast10WcAndStatusPacket(int id, Cus_EmWuchaType wcType)
            : base(true)
        {
            this.Pos = id;
            this.wcBoardQueryType = (int)wcType;
    ...
    internal class CL188M_RequestQueryCurrentErrorPacket : CL188LSendPacket
    {
        ...
        public CL188M_RequestQueryCurrentErrorPacket(Cus_EmCheckType Type)
            : base()
        {
            checkType = Type;
        }
