namespace CLDC_Encryption.CLEncryption.Interface
{
    #region --------------------代理说明---------------

    public delegate void Ept_EventRxFrame(string str_Frame);
    public delegate void Ept_EventTxFrame(string str_Frame);
    ...
    /// 功能：加密机操作接口
    /// </summary>
    public interface IAmMeterEncryption
    {
        /// <summary>
        /// 连接加密机
        /// </summary>
        ...
        int SouthOpenDevice(string szType, string cHostIp, int uiPort, int timeout, out string Message);
        /// <summary>
        /// 关闭设备
        /// </summary>
        /// <returns></returns>
        int SouthCloseDevice(out string Message);
        /// <summary>
        /// 获取随机数以及密文,用于远程身份认证。
        /// </summary>
        ...
        /// <returns></returns>
        int SouthIdentityAuthentication(int Flag, string PutDiv, out string OutRand, out string OutEndata, out string Message);
        /// <summary>
        /// 远程拉闸、合闸、报警等控制数据计算。
        /// </summary>
        /// <param name="Flag">表示电表密钥状态，整型，0: 测试密钥状态；1: 正式密钥状态；</param>
        ...
        /// <returns></returns>
        int SouthUserControl(int Flag, string PutRand, string PutDiv, string PutEsamNo,
string PutData, out string OutEndataout , out string Message);
        /// <summary>
        /// 用于参数信息计算。
        /// </summary>
        /// <param name="Flag">表示电表密钥状态，整型，0: 测试密钥状态；1: 正式密钥状态；</param>
        ...
        /// <returns></returns>
        int SouthParameterUpdate(int Flag, string PutRand, string PutDiv, string PutApdu, string PutData, out string OutData, out string Message);
        /// <summary>
        /// 用于当前套电价参数计算。
        /// </summary>
        /// <param name="Flag">表示电表密钥状态，整型，0: 测试密钥状态；1: 正式密钥状态；</param>
        ...
        /// <param name="OutData">输出的数据和MAC。</param>
        /// <returns></returns>
        int SouthPrice1Update(int Flag, string PutRand, string PutDiv, string PutApdu, string PutData, out string OutData, out string Message);
        /// <summary>
        /// 用于备用套电价参数计算。
        /// </summary>
        /// <param name="Flag">表示电表密钥状态，整型，0: 测试密钥状态；1: 正式密钥状态；</param>
        ...
        /// <param name="OutData">输出的数据和MAC。</param>
        /// <returns></returns>
        int SouthPrice2Update(int Flag, string PutRand, string PutDiv, string PutApdu, string PutData, out string OutData, out string Message);
        /// <summary>
        /// 用于远程二类参数设置计算。
        /// </summary>
        /// <param name="Flag">表示电表密钥状态，整型，0: 测试密钥状态；1: 正式密钥状态；</param>
        ...
        /// <returns></returns>
        int SouthParameterElseUpdate(int Flag, string PutRand, string PutDiv, string PutApdu, string PutData, out string OutEndata, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthIncreasePurse(int Flag, string PutRand, string PutDiv, string PutData, out string OutData, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthInitPurse(int Flag, string PutRand, string PutDiv, string PutData, out string OutData, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthKeyUpdateV2(int PutKeySum, string PutKeyState, string PutKeyId, string PutRand, string PutDiv, string PutEsamNo, out string OutData, out string Message);
        /// <summary>
        /// 用于生成电能表清零命令的密文。
        /// </summary>
        /// <param name="Flag">表示电表密钥状态，整型，0: 测试密钥状态；1: 正式密钥状态；</param>
        ...
        /// <returns></returns>
        int SouthDataClear1(int Flag, string PutRand, string PutDiv, string PutData, out string OutData, out string Message);
        /// <summary>
        /// 用于产生红外认证查询所需的随机数。
        /// </summary>
        /// <param name="OutRand1">输出的8字节随机数。</param>
        /// <returns></returns>
        int SouthInfraredRand(out string OutRand1, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthInfraredAuth(int Flag, string PutDiv, string PutEsamNo, string PutRand1, string PutRand1Endata, string PutRand2, out string OutRand2Endata, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthMacCheck(int Flag, string PutRand, string PutDiv, string PutApdu, string PutData, string PutMac, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthMacWrite(int Flag, string PutRand, string PutDiv, string PutEsamNo, string PutFileID, string PutDataBegin, string PutData, out string OutData, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthEncMacWrite(int Flag, string PutRand, string PutDiv, string PutEsamNo, string PutFileID, string PutDataBegin, string PutData, out string OutData, out string Message);
        /// <summary>
        /// 用于生成程序比对数据的密文。
        /// </summary>
        ...
        /// <returns></returns>
        int SouthEncForCompare(string PutKeyid, string PutDiv, string PutData, out string OutData, out string Message);
        /// <summary>
        ...
        /// <param name="OutEndata">输出的密文和MAC,字符型。</param>
        /// <returns></returns>
        int SouthDecreasePurse(int Flag, string PutRand, string PutDiv, string PutData, out string OutEndata, out string Message);
        /// <summary>
        ...
        /// <returns></returns>
        int SouthSwitchChargeMode(int Flag, string PutRand, string PutDiv, string PutData,
out string OutData, out string Message);
