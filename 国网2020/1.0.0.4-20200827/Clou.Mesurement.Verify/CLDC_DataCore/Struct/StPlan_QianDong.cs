...
namespace CLDC_DataCore.Struct
{
    ...
    public struct StPlan_QianDong
    {
        ...
        public void CheckTimeAndIb(string GuiChengName, CLDC_Comm.Enum.Cus_Clfs clfs, float U, string Ib, string Dj, string MeterConst, bool znq, bool hgq)
        {
            ...
            try
            {
                _ib = CLDC_DataCore.Function.Number.GetCurrentByIb("Ib", Ib, hgq);
            }
            catch
            {
            ...
            if (this.xTime == 0)
            {
                ...
                {
                    this.CheckTime = CLDC_DataCore.Function.QiDQianDFunction.getQianDongTime(GuiChengName, U, this.FloatxU, CLDC_DataCore.Function.Number.GetCurrentByIb("Imax", Ib, hgq), Dj, CLDC_DataCore.Function.Number.GetBcs(MeterConst, _Ywg == CLDC_Comm.Enum.Cus_Ywg.P ? true : false), clfs, _Ywg);
                }
