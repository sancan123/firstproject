...
namespace CLDC_DataCore.Struct
{
    ...
    public struct StPlan_QiDong
    {
        ...
        public void CheckTimeAndIb(string GuiChengName, CLDC_Comm.Enum.Cus_Clfs clfs, float U, string Ib, string Dj, string MeterConst, bool znq, bool hgq)
        {
            ...
            try
            {
                _ib = CLDC_DataCore.Function.Number.GetCurrentByIb("Itr", Ib, hgq);
            }
            catch
            {
            ...
            {
                this.CheckTime = CLDC_DataCore.Function.QiDQianDFunction.getQiDongTime(GuiChengName, U, this.FloatIb, CLDC_DataCore.Function.Number.GetBcs(MeterConst, _Ywg == CLDC_Comm.Enum.Cus_Ywg.P ? true : false), clfs, _Ywg);
