    ...
    internal class Connection
    {
        ...
        public bool Send(Packet.SendPacket sendPack, Packet.RecvPacket recvPack, string PortName)
        {
            ...
            if (vData == null)
            {
                ...
                RunLogFrame.Instance.WriteFrameLog(Lf);
            ...
            if (connection is COM32)
            {
                MessageController.Instance.AddMonitorMessage(EnumMonitorType.Frame, PortName + "|0");
            }
            ...
            if (vData != null && vData.Length > 0 && connection is COM32)
            {
                MessageController.Instance.AddMonitorMessage(EnumMonitorType.Frame, PortName + "|1");
            }
