...
namespace CLDC_DataCore.SocketModule.Sock
{
    ...
    internal class UDPClient : IConnection
    {
        ...
        public UDPClient(string Ip, int BindPort, int RemotePort, int BasePort)
        {
            ...
            portNameTemp = string.Format("{0}_{1}_{2}_{3}", Ip, RemotePort, BasePort, BindPort);
        }
        ...
        public bool SendData(ref byte[] vData, bool IsReturn, int WaiteTime)
        {
            ...
            MessageController.Instance.AddMonitorMessage(CLDC_Comm.Enum.EnumMonitorType.Frame, portNameTemp + "|0");
            ...
            else
            {
                ...
                MessageController.Instance.AddMonitorMessage(CLDC_Comm.Enum.EnumMonitorType.Frame, portNameTemp + "|1");
            }
