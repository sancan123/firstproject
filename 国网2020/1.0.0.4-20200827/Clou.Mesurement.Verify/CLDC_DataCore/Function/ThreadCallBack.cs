...
namespace CLDC_DataCore.Function
{
    ...
    public class ThreadCallBack
    {
        ...
        {
            CLDC_Comm.ThreadPool.QueueUserWorkItem(new WaitCallback(thCall), new object[] { callBack, DelayMSecond });
        }
        ...
        public static void BeginInvoke(Control InvokeParent, CallBack callBack, int DelayMSecond)
        {
            ...
            CLDC_Comm.ThreadPool.QueueUserWorkItem(new WaitCallback(thBeginInvoke), new object[] { InvokeParent, callBack, DelayMSecond });
        }
        ...
        public static void BeginInvoke(Control InvokeParent, CallBack_Params callBack, int DelayMSecond, params object[] objParams)
        {
            ...
            CLDC_Comm.ThreadPool.QueueUserWorkItem(new WaitCallback(thBeginInvoke2), new object[] { InvokeParent, callBack, DelayMSecond, objParams });
        }
