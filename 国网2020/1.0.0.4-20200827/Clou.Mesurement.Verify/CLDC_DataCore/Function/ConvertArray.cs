...
namespace CLDC_DataCore.Function
{
    ...
    public class ConvertArray
    {
        ...
        /// <param name="arrInput">要转换的数组</param>
        /// <returns></returns>
        public static string[] ConvertDateTime2String(DateTime[] arrInput)
        {
            Converter<DateTime, string> myCon = new Converter<DateTime, string>(CDateTime2string);
            string[] _fl = Array.ConvertAll<DateTime, string>(arrInput, myCon);
            return _fl;

        }

        private static string CDateTime2string(DateTime str)
        {
            try
            {
        ...
        public static bool[] ConvertStr2Bool(string[] arrInput)
        {
            Converter<string, bool> myCon = new Converter<string, bool>(Cstr2Bool);
            bool[] _fl = Array.ConvertAll<string, bool>(arrInput, myCon);
            return _fl;
        }

        private static bool Cstr2Bool(string str)
        {
            try
            {
