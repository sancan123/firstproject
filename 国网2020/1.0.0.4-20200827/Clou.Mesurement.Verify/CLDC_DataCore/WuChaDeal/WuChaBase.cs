...
namespace CLDC_DataCore.WuChaDeal
{
    abstract class WuChaBase
    {
        ...
        /// 误差计算配置参数
        /// </summary>
        private Struct.StWuChaDeal m_WuChaPara;
        /// <summary>
        /// 误差化整间距表
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        public WuChaBase(Struct.StWuChaDeal WuChaDeal)
        {
        ...
        /// 也可以在构造时引入本参数
        /// </summary>
         public Struct.StWuChaDeal WuChaPara
         {
             get
             {
                 return m_WuChaPara;
         ...
         //<returns></returns>
        public virtual MeterErrorBase SetWuCha(params  float[] arrNumber)
        {
            return new MeterErrorBase();
        }
        ...
        {
            return GlobalUnit.GetConfig(Variable.CTC_WC_AVGPRECISION, 4);
