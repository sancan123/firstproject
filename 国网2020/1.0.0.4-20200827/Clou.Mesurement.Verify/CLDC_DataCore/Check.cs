...
namespace CLDC_DataCore
{
    ...
    public sealed class Check
    {
        ...
        public static void Assert(bool assertion, string message)
        {
            ...
            {
                if (!assertion)
                    MessageController.Instance.AddMessage(message, 6);
            }
            else
            {
#if USE_TRACE_ASSERTION
        ...
        public static void Assert(bool assertion, string message, Exception inner)
        {
            ...
            {
                if (!assertion)
                    MessageController.Instance.AddMessage(message, 6,2);
            }
            else
            {
#if USE_TRACE_ASSERTION
        ...
        public static void Assert(bool assertion)
        {
            if (UseExceptions)
            {
                if (!assertion)
                {
                    MessageController.Instance.AddMessage(ASSERTION_FAILED, 6,2);
                }
            }
            else
            {
