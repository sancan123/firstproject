...
namespace CLDC_VerifyAdapter.EventLog
{
    ...
    /// 电压逆相序事件记录
    /// </summary>
    class EL_VoltageReversePhase:EventLogBase
    {
        public EL_VoltageReversePhase(object plan)
            : base(plan) 
        {
        ...
        public override void Verify()
        {
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读电压逆相序事件产生前逆相序总次数");
            string[] strLoseCountQ = MeterProtocolAdapter.Instance.ReadData("14000001", 3);
           ...
           for (int it = 0; it < 1; it++)
           {
               ...
               MessageController.Instance.AddMessage("正在进行第" + (it + 1) + "次让电能表电压逆相序以便形成失压记录...");
               ...
               CLDC_VerifyAdapter.Helper.EquipHelper.Instance.PowerOn(GlobalUnit.U, GlobalUnit.U, GlobalUnit.U, GlobalUnit.Ib, GlobalUnit.Ib, GlobalUnit.Ib, (int)Cus_PowerYuanJian.H, 50, "1.0", false, false, false, (int)Cus_PowerFangXiang.正向有功);
               ShowWaitMessage("正在等待{0}秒,请稍候....", 1000 * 63);
           }

            if (Stop) return;
            MessageController.Instance.AddMessage("正在读取逆相序事件产生后逆相序总次数");
            string[] strLoseCountH = MeterProtocolAdapter.Instance.ReadData("14000001", 3);
            ...
            string[] strLoseTimeQ = MeterProtocolAdapter.Instance.ReadData("14000101", 6);
            ...
            string[] strLoseTimeQ4 = MeterProtocolAdapter.Instance.ReadData("14000104", 6);
            ...
            string[] strLoseTimeQ7 = MeterProtocolAdapter.Instance.ReadData("14000107", 6);
            ...
            string[] strLoseTimeQ10 = MeterProtocolAdapter.Instance.ReadData("1400010A", 6);
