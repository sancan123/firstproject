...
namespace CLDC_VerifyAdapter.EventLog
{
    ...
    /// 电流逆相序事件记录
    /// </summary>
    class EL_CurrentReversePhase:EventLogBase
    {
        public EL_CurrentReversePhase(object plan)
            : base(plan) 
        {
        ...
        public override void Verify()
        {
            ...
            string[] strLoseCountQ = MeterProtocolAdapter.Instance.ReadData("15000001", 3);
           ...
           for (int it = 0; it < 1; it++)
           {
               ...
               MessageController.Instance.AddMessage("正在进行第" + (it + 1) + "次让电能表电流逆相序以便形成失压记录...");
            ...
            string[] strLoseCountH = MeterProtocolAdapter.Instance.ReadData("15000001", 3);
            ...
            string[] strLoseTimeQ = MeterProtocolAdapter.Instance.ReadData("15000101", 6);
            ...
            string[] strLoseTimeQ4 = MeterProtocolAdapter.Instance.ReadData("15000104", 6);
            ...
            string[] strLoseTimeQ7 = MeterProtocolAdapter.Instance.ReadData("15000107", 6);
            ...
            string[] strLoseTimeQ10 = MeterProtocolAdapter.Instance.ReadData("1500010A", 6);
