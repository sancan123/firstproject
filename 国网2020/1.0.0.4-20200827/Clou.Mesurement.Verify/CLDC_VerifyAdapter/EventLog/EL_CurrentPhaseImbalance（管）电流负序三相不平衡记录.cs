...
{
    /// <summary>
    /// （管）电三相不平衡记录，（管）电流负序三相不平衡记录 - 复制
    /// </summary>
    class EL_CurrentPhaseImbalance:EventLogBase
    {
        public EL_CurrentPhaseImbalance(object plan)
            : base(plan) 
        {
        ...
        public override void Verify()
        {
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读电流负序三相不平衡记录总次数");
            string[] strLoseCountQ = MeterProtocolAdapter.Instance.ReadData("03BA0000", 3);
            ...
            for (int i = 0; i < BwCount; i++)
            {
                ...
                if (strLoseCountQ[i] == "")
                {
                    ...
                    reasonS[i] = "第一次读电流负序三相不平衡记录总次数返回次数值为空";
           ...
           for (int it = 0; it < 1; it++)
           {
               ...
               MessageController.Instance.AddMessage("正在进行第" + (it + 1) + "次产生电流负序三相不平衡记录..."); 
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读取电流负序三相不平衡记录总次数");
            string[] strLoseCountH = MeterProtocolAdapter.Instance.ReadData("03BA0000", 3);
            ...
            string[] strLoseTimeQ = MeterProtocolAdapter.Instance.ReadData("03BA0001", 6);
            ...
            string[] strLoseTimeQ4 = MeterProtocolAdapter.Instance.ReadData("03BA0004", 6);
            ...
            string[] strLoseTimeQ7 = MeterProtocolAdapter.Instance.ReadData("03BA0007", 6);
            ...
            string[] strLoseTimeQ10 = MeterProtocolAdapter.Instance.ReadData("03BA000A", 6);
