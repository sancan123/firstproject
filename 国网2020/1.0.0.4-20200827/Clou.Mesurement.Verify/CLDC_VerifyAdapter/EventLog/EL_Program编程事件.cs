...
{
    /// <summary>
    /// 编程事件记录，模拟触发10次，读取1,4，7，10
    /// </summary>
    class EL_Program : EventLogBase
    {
      
        public EL_Program(object plan)
            : base(plan) 
        {
        ...
        public override void Verify()
        {
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读取电表编程记录产生后编程记录总次数");
            string[] strLoseCountH = MeterProtocolAdapter.Instance.ReadData("03300000", 3);
            ...
            string[] strLoseTimeQ = MeterProtocolAdapter.Instance.ReadData("03300001", 6);
