...
{
    class SetTerminalTemOut:VerifyBase
    {


           #region ----------构造函数----------

        public SetTerminalTemOut(object plan)
            : base(plan)
        {
        }
        ...
        public override void Verify()
        {
           ...
           string[] Fail = new string[BwCount];
            ...
            MessageController.Instance.AddMessage("正在读取端子座温度超限跳闸阀值");
            string[] flt_DL = MeterProtocolAdapter.Instance.ReadData("04091301",2);
            ...
            string writedata = FormatWriteData("1400", "NNNN", 2, 0);
            Common.Memset(ref strDataCode, "04091301");
            Common.Memset(ref strData, "04091301" + writedata);
            ...
            string[] flt_Tzz2 = MeterProtocolAdapter.Instance.ReadData("04091301",2);
            ...
            string writedata1 = FormatWriteData("1350", "NNNN", 2, 0);
            Common.Memset(ref strDataCode, "04091301");
            Common.Memset(ref strData, "04091301" + writedata1);
