...
{
    class SetTerminalTemUn:VerifyBase
    {


           #region ----------构造函数----------

        public SetTerminalTemUn(object plan)
            : base(plan)
        {
        }
        ...
        public override void Verify()
        {
           ...
           MessageController.Instance.AddMessage("正在读取端子温度不平衡报警阈值");
            string[] flt_DL = MeterProtocolAdapter.Instance.ReadData("04091501",2);
            ...
            Common.Memset(ref strDataCode, "04091501");
            Common.Memset(ref strData, "04091501" + writedata);
            ...
            string[] flt_Tzz2 = MeterProtocolAdapter.Instance.ReadData("04091501", 2);
            ...
            Common.Memset(ref strDataCode, "04091501");
            Common.Memset(ref strData, "04091501" + writedata1);
