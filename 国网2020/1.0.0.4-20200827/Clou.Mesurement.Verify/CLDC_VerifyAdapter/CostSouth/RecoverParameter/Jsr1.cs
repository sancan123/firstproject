   ...
   public class Jsr1:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter2", "04000B01", "");
            ...
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04000B01", 2);
