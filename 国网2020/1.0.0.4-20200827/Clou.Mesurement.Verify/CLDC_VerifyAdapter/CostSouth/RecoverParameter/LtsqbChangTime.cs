...
namespace CLDC_VerifyAdapter.CostSouth.RecoverParameter
{
    ...
    /// 两套时区表切换时间（恢复）
    /// </summary>
   public class LtsqbChangTime:VerifyBase
    {
        ...
        public LtsqbChangTime(object plan)
            : base(plan)
        {
        }
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter2", "04000106", "");
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读取两套时区表切换时间,请稍候....");
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04000106", 5);
