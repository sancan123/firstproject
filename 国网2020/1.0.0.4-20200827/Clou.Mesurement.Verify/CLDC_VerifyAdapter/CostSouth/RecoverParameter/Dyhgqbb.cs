...
namespace CLDC_VerifyAdapter.CostSouth.RecoverParameter
{
    ...
    /// 电压互感器变比（恢复）
    /// </summary>
   public class Dyhgqbb:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter1", "04000307", "");
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在进行设置电压互感器变比,请稍候....");
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读取电压互感器变比,请稍候....");
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04000307", 3);
