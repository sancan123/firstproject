   ...
   public class Bjje2:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter1", "04001002", "");
            ...
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04001002", 4);
