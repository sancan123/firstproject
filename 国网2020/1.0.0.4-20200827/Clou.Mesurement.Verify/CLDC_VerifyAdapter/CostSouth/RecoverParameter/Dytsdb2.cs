...
namespace CLDC_VerifyAdapter.CostSouth.RecoverParameter
{
    ...
    /// 第一套第2日时段表（恢复）
    /// </summary>
   public class Dytsdb2:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter2", "04010002", "");
            ...
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04010002", 42);
            for (int i = 0; i < BwCount; i++)
            {
