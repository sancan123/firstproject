...
namespace CLDC_VerifyAdapter.CostSouth.RecoverParameter
{
    ...
    /// 囤积金额限值（恢复）
    /// </summary>
   public class Tjjexz:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter2", "04001004", "");
            ...
            for (int i = 0; i < BwCount; i++)
            {
                if (i <= DataTmp.Length && !string.IsNullOrEmpty(DataTmp[i]))
                {
                    ...
                    strData[i] = "04001004" + DataTmp[i];
                }
            }
            Common.Memset(ref strID, "04001004");
            ...
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04001004", 4);
