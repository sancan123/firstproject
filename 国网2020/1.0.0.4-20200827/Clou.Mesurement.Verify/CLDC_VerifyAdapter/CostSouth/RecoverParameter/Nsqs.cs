   ...
   public class Nsqs:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter2", "04000201", "");
            ...
            for (int i = 0; i < BwCount; i++)
            {
                if (i <= DataTmp.Length && !string.IsNullOrEmpty(DataTmp[i]))
                {
                    ...
                    strData[i] = "04000201" + DataTmp[i];
                }
            }
            Common.Memset(ref strID, "04000201");
            ...
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04000201", 1);
