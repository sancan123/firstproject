...
namespace CLDC_VerifyAdapter.CostSouth.RecoverParameter
{
    ...
    /// 第一套第1日时段表（恢复）
    /// </summary>
   public class Dytsdb1:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter2", "04010001", "");
            ...
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04010001", 42);
            for (int i = 0; i < BwCount; i++)
            {
