   ...
   public class Fls:VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string strReaderFileData = CLDC_DataCore.Function.File.ReadInIString(strFile, "Parameter2", "04000204", "");
            ...
            for (int i = 0; i < BwCount; i++)
            {
                if (i <= DataTmp.Length && !string.IsNullOrEmpty(DataTmp[i]))
                {
                    ...
                    strData[i] = "04000204" + DataTmp[i];
                }
            }
            Common.Memset(ref strID, "04000204");
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读取日时费率数,请稍候....");
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04000204", 1);
