...
namespace CLDC_VerifyAdapter.CostSouth.LocalMode
{
    public class CardTest_Fz : VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            MessageController.Instance.AddMessage("正在发行开户卡,请稍候....");
            ...
            //{
            //    if (!Helper.MeterDataHelper.Instance.Meter(i).YaoJianYn) continue;
            //    WriteUserResult[i] = MeterProtocolAdapter.Instance.SouthWriteUserCard(i,strParaFileArr[i], strwalletFileArr[i], strpriceFile1Arr[i], strpriceFile2Arr[i], strfileReplyArr[i], strControlFilePlainArr[i]);
            //}
