...
namespace CLDC_VerifyAdapter.CostSouth.ReaderParameter
{
    ...
    public class Dytsqb : VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("04010000",42);
            for (int i = 0; i < BwCount; i++)
            {
                strRedData[i] = CLDC_DataCore.Function.Common.SortMin(strRedData[i]);
            ...
            CLDC_DataCore.Function.File.WriteInIString(strFile, "Parameter2", "04010000", strReaderData);
