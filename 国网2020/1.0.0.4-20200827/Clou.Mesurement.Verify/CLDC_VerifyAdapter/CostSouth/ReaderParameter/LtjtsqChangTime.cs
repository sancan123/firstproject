...
namespace CLDC_VerifyAdapter.CostSouth.ReaderParameter
{
    ...
    /// 两套阶梯时区切换时间（读取）
    /// </summary>
    public class LtjtsqChangTime : VerifyBase
    {
        ...
        public LtjtsqChangTime(object plan)
            : base(plan)
        {
        }
        ...
        public override void Verify()
        {
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("正在读取两套阶梯时区切换时间,请稍候....");
            string[] strRedData = MeterProtocolAdapter.Instance.ReadData("0400010A", 5);
            ...
            CLDC_DataCore.Function.File.WriteInIString(strFile, "Parameter2", "0400010A", strReaderData);
