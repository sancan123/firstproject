...
{
    class VoltageChange  : VerifyBase
    {
        #region ----------变量声明----------
        ...
        #endregion
        public VoltageChange(object plan)
            : base(plan)
        {
        ...
        protected override bool CheckPara()
        {
            ...
            st_Wc.XiangXu = 0;
            st_Wc.XieBo = 0;
            xUa = float.Parse(arrayErrorPara[9].ToString().Trim('%')) / 100;
            xUb = float.Parse(arrayErrorPara[10].ToString().Trim('%')) / 100;
            xUc = float.Parse(arrayErrorPara[11].ToString().Trim('%')) / 100;
            CurPlan = st_Wc;
        ...
        */
        ...
        private bool InitEquipment(StPlan_WcPoint _curPoint, float PL, int[] _Pulselap, bool before)
        {
            ...
            if (!before) //yxian
            {
                ...
                result = Helper.EquipHelper.Instance.PowerOn(GlobalUnit.U * xUa, GlobalUnit.U * xUb, GlobalUnit.U * xUc, _xIb, _xIb, _xIb, (int)_curPoint.PowerYuanJian, 50, _curPoint.PowerYinSu, IsYouGong, false, false, (int)_curPoint.PowerFangXiang);
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "电压改变试验影响前固有误差_否_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" + "100%" + "_" + arrayErrorPara[4] ;
