...
{
    class SquareTopWave : VerifyBase
    {
        #region ----------变量声明----------
        ...
        #endregion
        public SquareTopWave(object plan)
            : base(plan)
        {
        ...
        */
        ...
        private bool InitEquipment(StPlan_WcPoint _curPoint, float PL, int[] _Pulselap, bool before)
        {
            ...
            if (!before) //yxian
            {
                ...
                EquipHelper.Instance.SetJd_Pd(0, 2, 0, 2, 0, 2);
            ...
            if (!result)
            {
                ...
                ShowWaitMessage("谐波源将在{0}秒后稳定输出，请等待", 45000);
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "方顶波试验影响前固有误差_否_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" + "100%" + "_" + arrayErrorPara[4];
