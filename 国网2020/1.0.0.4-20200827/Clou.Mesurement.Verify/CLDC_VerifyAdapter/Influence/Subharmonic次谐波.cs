...
namespace CLDC_VerifyAdapter.Influence
{
    class Subharmonic  : VerifyBase
    {
        ...
        #endregion
        public Subharmonic(object plan)
            : base(plan)
        {
        ...
        */
        ...
        private bool InitEquipment(StPlan_WcPoint _curPoint, float PL, int[] _Pulselap, bool before)
        {
            ...
            if (!before) //yxian
            {
                ...
                EquipHelper.Instance.SettingWaveformSelection(0, 4, 0, 4, 0, 4);
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "90度相位触发波形试验影响前固有误差_否_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" + "100%" + "_" + arrayErrorPara[4];
