...
{
    class InversePhaseSequence  : VerifyBase
    {
        #region ----------变量声明----------
        ...
        #endregion
        public InversePhaseSequence(object plan)
            : base(plan)
        {
        ...
        */
        ...
        private bool InitEquipment(StPlan_WcPoint _curPoint, float PL, int[] _Pulselap, bool before)
        {
            ...
            if (!before) //yxian
            {
                ...
                result = Helper.EquipHelper.Instance.PowerOn(GlobalUnit.U, GlobalUnit.U, GlobalUnit.U, _xIb, _xIb, _xIb, (int)_curPoint.PowerYuanJian, 50, _curPoint.PowerYinSu, IsYouGong, false, true, (int)_curPoint.PowerFangXiang);
                if (!result)
                {
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "逆相序试验影响前固有误差_否_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" + "100%" + "_" + arrayErrorPara[4];
