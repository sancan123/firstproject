...
{
    class Harmonic5thInfluence: VerifyBase
    {
        #region ----------变量声明----------
        ...
        #endregion
        public Harmonic5thInfluence(object plan)
            : base(plan)
        {
        ...
        */
        ...
        private bool InitEquipment(StPlan_WcPoint _curPoint, float PL, int[] _Pulselap, bool before)
        {
            ...
            if (!before) //yxian
            {
                ...
                GlobalUnit.IsJdb = true;
                float Content = 0.4F * _xIb * 0.01F;
                ...
                for (int g = 0; g < 3; g++)
                {
                    ...
                    arrPara[g].Content[4] = 0.1f;
                    arrPara[g].TimeSwitch[0] = true;
                    arrPara[g].TimeSwitch[4] = true;
                    arrPara[g].IsOpen = true;
                }
                for (int h = 3; h < 6; h++)
                {
                    arrPara[h].Content[0] = 1F;
                    arrPara[h].Content[4] = Content;
                    arrPara[h].TimeSwitch[0] = true;
                    arrPara[h].TimeSwitch[4] = true;
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "5次谐波试验影响前固有误差_否_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" + "100%" + "_" + arrayErrorPara[4];
