...
namespace CLDC_VerifyAdapter.Influence
{
    ...
    /// 谐波分量
    /// </summary>
    class HarmonicContent: VerifyBase
    {
        #region ----------变量声明----------
        ...
        #endregion
        public HarmonicContent(object plan)
            : base(plan)
        {
        ...
        protected override bool CheckPara()
        {
            ...
            xIa = float.Parse(arrayErrorPara[12].ToString().Trim('%')) / 100;
            xIb = float.Parse(arrayErrorPara[13].ToString().Trim('%')) / 100;
            xIc = float.Parse(arrayErrorPara[14].ToString().Trim('%')) / 100;
            Cs = int.Parse(arrayErrorPara[15].ToString());
            //每一个误差点取几次误差参与计算
        ...
        private bool InitEquipment(StPlan_WcPoint _curPoint, float PL, int[] _Pulselap, bool before)
        {
            ...
            if (!before) //yxian
            {
                ...
                if (xUa != 0)
                {
                    ...
                    arrPara[0].Content[Cs] = xUa * 0.01F;
                ...
                if (xUb != 0)
                {
                    arrPara[1].Content[0] = 1F;
                    arrPara[1].Content[Cs] = xUb * 0.01F;
                    arrPara[1].TimeSwitch[0] = true;
                    arrPara[1].TimeSwitch[Cs] = true;
                    arrPara[1].IsOpen = true;
                }
                if (xUc != 0)
                {
                    arrPara[2].Content[0] = 1F;
                    arrPara[2].Content[Cs] = xUc * 0.01F;
                    arrPara[2].TimeSwitch[0] = true;
                    arrPara[2].TimeSwitch[Cs] = true;
                    arrPara[2].IsOpen = true;
                }
                if (xIa != 0)
                {
                    arrPara[3].Content[0] = 1F;
                    arrPara[3].Content[Cs] = xIa * 0.01F;
                ...
                if (xIb != 0)
                {
                    arrPara[4].Content[0] = 1F;
                    arrPara[4].Content[Cs] = xIb * 0.01F;
                    arrPara[4].TimeSwitch[0] = true;
                    arrPara[4].TimeSwitch[Cs] = true;
                    arrPara[4].IsOpen = true;
                }
                if (xIc != 0)
                {
                    arrPara[5].Content[0] = 1F;
                    arrPara[5].Content[Cs] = xIc * 0.01F;
                    arrPara[5].TimeSwitch[0] = true;
                    arrPara[5].TimeSwitch[Cs] = true;
                    arrPara[5].IsOpen = true;
                }
