...
{
    class LoadUnbalance : VerifyBase
    {
        #region ----------变量声明----------
        ...
        #endregion
        public LoadUnbalance(object plan)
            : base(plan)
        {
        ...
        */
        ...
        private bool InitEquipment(StPlan_WcPoint _curPoint, float PL, int[] _Pulselap, bool before)
        {
            ...
            if (!before) //yxian
            {
                ...
                {
                    case "A相":
                        result = Helper.EquipHelper.Instance.PowerOn(GlobalUnit.U, GlobalUnit.U, GlobalUnit.U, _xIb, 0, 0, (int)_curPoint.PowerYuanJian, 50, _curPoint.PowerYinSu, IsYouGong, false, false, (int)_curPoint.PowerFangXiang);
                        break;
                    case "B相":
                        result = Helper.EquipHelper.Instance.PowerOn(GlobalUnit.U, GlobalUnit.U, GlobalUnit.U, 0, _xIb, 0, (int)_curPoint.PowerYuanJian, 50, _curPoint.PowerYinSu, IsYouGong, false, false, (int)_curPoint.PowerFangXiang);
                        break;
                    case "C相":
                        result = Helper.EquipHelper.Instance.PowerOn(GlobalUnit.U, GlobalUnit.U, GlobalUnit.U, 0, 0, _xIb, (int)_curPoint.PowerYuanJian, 50, _curPoint.PowerYinSu, IsYouGong, false, false, (int)_curPoint.PowerFangXiang);
                        break;
                    default:
                        result = false;
                        break;
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "负载不平衡试验影响前固有误差_否_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" + "100%" + "_" + arrayErrorPara[4];
