    ...
    class VoltageDip : VerifyBase
    {
        ...
        public override void Verify()
        {
            ...
            for (int i = 0; i < BwCount; i++)
            {
                ...
                if (string.IsNullOrEmpty(strProjectName[i]) || string.IsNullOrEmpty(strVALUE[i]))
                {
                    CheckOver = true;
                    break;
                }
        ...
        */
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "电压暂降和短时中断试验影响前固有误差_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" + arrayErrorPara[4];
