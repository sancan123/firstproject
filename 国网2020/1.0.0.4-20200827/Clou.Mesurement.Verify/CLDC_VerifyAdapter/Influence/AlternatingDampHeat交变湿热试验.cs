...
namespace CLDC_VerifyAdapter.Influence
{
    ...
    /// 交变湿热试验
    /// </summary>
    class AlternatingDampHeat : VerifyBase
    {
        #region ----------变量声明----------
        ...
        #endregion
        public AlternatingDampHeat(object plan)
            : base(plan)
        {
        ...
        public override void Verify()
        {
            ...
            if (CheckOver)
            {
                System.Windows.Forms.MessageBox.Show("请确定以下表位有测试影响前误差:" + Bw);
                return;
            }
        ...
        */
        ...
        public string GetWCProjectName()
        {
          ...
          //  影响前误差_正向有功_H_1.0_10Itr
            ...
            string[] arrayErrorPara = VerifyPara.Split('|');
            string WcProjectName = "初始固有误差_" + arrayErrorPara[1] + "_" + arrayErrorPara[2] + "_" + arrayErrorPara[3] + "_" ;
