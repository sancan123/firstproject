...
{
    class PullLight:VerifyBase
    {


           #region ----------构造函数----------

        public PullLight(object plan)
            : base(plan)
        {
        }
        ...
        public override void Verify()
        {
           ...
           if (Stop) return;
           MessageController.Instance.AddMessage("使电表拉闸...");
           Helper.EquipHelper.Instance.BreakRelay();


           Form_Ariticial fs = new Form_Ariticial("拉闸指示灯");
            fs.ShowDialog();
            ...
            if (Stop) return;
            MessageController.Instance.AddMessage("使电表合闸...");
