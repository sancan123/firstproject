...
namespace CLDC_VerifyAdapter
{
    ...
    /// 正常校时
    /// </summary>
  public  class BroadcastingTimeNormal:VerifyBase
    {
      public BroadcastingTimeNormal(object plan)
            : base(plan)
        { }
      ...
      public override void Verify()
      {
          ...
          MessageController.Instance.AddMessage("正在修改电表时间早15分钟...");
          string strSetTime2 = dt2.AddMinutes(-15).ToString("yyMMddHHmmss");
          ...
          for (int i = 0; i < BwCount; i++)
          {
              ...
              else
              {
                  ...
                  if ((Err2>= 880 && Err2 <= 940))
                  {
                      reasonS[i] = "第二次校时不应该校时，超过15分钟不校时";
                  }
              }
          }
