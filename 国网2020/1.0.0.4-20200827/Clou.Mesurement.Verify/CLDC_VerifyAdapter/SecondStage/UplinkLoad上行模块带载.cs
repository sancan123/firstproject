...
namespace CLDC_VerifyAdapter.SecondStage
{
    ...
    /// 上行模块带载
    /// </summary>
    class UplinkLoad :VerifyBase
    {


           #region ----------构造函数----------

        public UplinkLoad(object plan)
            : base(plan)
        {
        }
        ...
        public override void Verify()
        {
          ...
          System.Windows.Forms.MessageBox.Show("请测量上行模块带载后点击确定。");

            Form_Ariticial fs = new Form_Ariticial("上行模块接口带载实验");
            fs.ShowDialog();
