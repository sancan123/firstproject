...
{
    class BlackoutDisplay:VerifyBase
    {


           #region ----------构造函数----------

        public BlackoutDisplay(object plan)
            : base(plan)
        {
        }
        ...
        public override void Verify()
        {
           ...
           bool bPowerOff = Helper.EquipHelper.Instance.PowerOff();

           Form_Ariticial fs = new Form_Ariticial("停电时显示");
            fs.ShowDialog();
