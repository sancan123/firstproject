...
namespace CLDC_SafeFileProtocol.Model
{
    public class CardFilePrice2
    {
        ...
        private byte[] _stepChangeTime = new byte[5];
        ...
        public string price2Day1
        {
            ...
            set
            {
                ...
                {
                    Tools.DataConvert tdc = new Tools.DataConvert();
                    _price2Day1 = tdc.stringToByte(value);
                }
                else
                {
                    throw new Exception("数据格式错误!");
        ...
        public string price2Day2
        {
            ...
            set
            {
                ...
                {
                    Tools.DataConvert tdc = new Tools.DataConvert();
                    _price2Day2 = tdc.stringToByte(value);
                }
                else
                {
                    throw new Exception("数据格式错误!");
        ...
        public string price2Day3
        {
            ...
            set
            {
                ...
                {
                    Tools.DataConvert tdc = new Tools.DataConvert();
                    _price2Day3 = tdc.stringToByte(value);
                }
                else
                {
                    throw new Exception("数据格式错误!");
        ...
        public string price2Day4
        {
            ...
            set
            {
                ...
                {
                    Tools.DataConvert tdc = new Tools.DataConvert();
                    _price2Day4 = tdc.stringToByte(value);
                }
                else
                {
                    throw new Exception("数据格式错误!");
        ...
        public string price2Day5
        {
            ...
            set
            {
                ...
                {
                    Tools.DataConvert tdc = new Tools.DataConvert();
                    _price2Day5 = tdc.stringToByte(value);
                }
                else
                {
                    throw new Exception("数据格式错误!");
        ...
        public string price2Day6
        {
            ...
            set
            {
                ...
                {
                    Tools.DataConvert tdc = new Tools.DataConvert();
                    _price2Day6 = tdc.stringToByte(value);
                }
                else
                {
                    throw new Exception("数据格式错误!");
        ...
        public string stepChangeTime
        {
            get
            {
                return BitConverter.ToString(_stepChangeTime).Replace("-", "");
            }
            set
            {
                ...
                {
                    Tools.DataConvert tdc = new Tools.DataConvert();
                    _stepChangeTime = tdc.stringToByte(value);
                }
                else
                {
                    throw new Exception("数据格式错误!");
        ...
        public byte[] GetData()
        {
            ...
            lst_tmp.AddRange(_stepChangeTime);
